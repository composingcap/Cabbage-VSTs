...
;Adapted for 8 channel use by Christopher Poovey

<Cabbage> bounds(0, 0, 0, 0)
form caption("MVerbR") size(650, 360) colour(58, 110, 182) pluginid("def1") fontcolour("white")
...
if changed(kIO) == 1 then
    SchanName sprintfk "id_ch%d", kIO
    chnset "visible(1)", SchanName
    
    if kLastIO != 0 then
       SchanName sprintfk "id_ch%d", kLastIO
       chnset "visible(0)", SchanName 
    endif
...
ga3mix=dcblock2(ga2mix+a3)
ga4mix=dcblock2(ga2mix+a4)
ga5mix=dcblock2(ga2mix+a5)
ga6mix=dcblock2(ga2mix+a6)
ga7mix=dcblock2(ga2mix+a7)
ga8mix=dcblock2(ga2mix+a8)
endin
...
;Tap in to given scattering junctions
...
aGU,aGR,aGD,aGL mesh    aBD,aHL,aLU,aFR,adel7

aHU,aHR,aHD,aHL mesh    aCD,aIL,aMU,aGR,adel8  

aIU,aIR,aID,aIL mesh    aDD,aJL,aNU,aHR,adel9

aJU,aJR,aJD,aJL meshEQ    aED,aJR,aOU,aIR,adel10,kFB

aKU,aKR,aKD,aKL meshEQ    aFD,aLL,aPU,aKL,adel11,kFB

aLU,aLR,aLD,aLL mesh    aGD,aML,aQU,aKR,adel12

aMU,aMR,aMD,aML mesh    aHD,aNL,aRU,aLR,adel13

aNU,aNR,aND,aNL mesh    aID,aOL,aSU,aMR,adel14

aOU,aOR,aOD,aOL meshEQ    aJD,aOR,aTU,aNR,adel15,kFB

aPU,aPR,aPD,aPL meshEQ    aKD,aQL,aUU,aPL,adel16,kFB

aQU,aQR,aQD,aQL mesh    aLD,aRL,aVU,aPR,adel17

aRU,aRR,aRD,aRL mesh    aMD,aSL,aWU,aQR,adel18

aSU,aSR,aSD,aSL mesh    aND,aTL,aXU,aRR,adel19

aTU,aTR,aTD,aTL meshEQ    aOD,aTR,aYU,aSR,adel20,kFB

aUU,aUR,aUD,aUL meshEQ    aPD,aVL,aUD,aUL,adel21,kFB

aVU,aVR,aVD,aVL meshEQ    aQD,aWL,aVD,aUR,adel22,kFB

aWU,aWR,aWD,aWL meshEQ    aRD,aXL,aWD,aVR,adel23,kFB

aXU,aXR,aXD,aXL meshEQ    aSD,aYL,aXD,aWR,adel24,kFB

aYU,aYR,aYD,aYL meshEQ    aTD,aYR,aYD,aXR,adel25,kFB
...
outo    (garev1*gkFX)+(ga1mix*gksource),(garev2*gkFX)+(ga2mix*gksource),(garev3*gkFX)+(ga3mix*gksource) ,(garev4*gkFX)+(ga4mix*gksource) ,(garev5*gkFX)+(ga5mix*gksource) ,(garev6*gkFX)+(ga6mix*gksource) ,(garev7*gkFX)+(ga7mix*gksource) ,(garev8*gkFX)+(ga8mix*gksource)  
endin

instr 101   ;clear global audio
clear   ga1mix, ga2mix,ga3mix, ga4mix,ga5mix, ga6mix,ga7mix, ga8mix, garev1, garev2, garev3, garev4, garev5, garev6, garev7, garev8
endin
